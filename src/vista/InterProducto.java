...
public class InterProducto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txt_cantidad.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        ...
        txt_precio.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        ...
        jComboBox_iva.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        ...
        jComboBox_categoria.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        ...
        getContentPane().add(jButton_Guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 90, -1));
    ...
    private void jButton_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarActionPerformed
        ...
        Producto producto = new Producto(); //instancio objeto de modelo producto
        Ctrl_Producto controlproducto = new Ctrl_Producto();
        String iva = ""; //variable iva de tipo string
        String categoria = "";
        // seleccionar jcombobox 
        ...
        if (txt_nombre.getText().equals("") || txt_cantidad.getText().equals("") || txt_precio.getText().equals("")) {
            ...
            //consulta para ver si producto ya existe en la BD
                ...
                if (iva.equalsIgnoreCase("Seleccione Iva")) {
                    ...
                    if (categoria.equalsIgnoreCase("Seleccione Categoria")) {
                        ...
                        try {
                            ...
                            //como cantidad es entero uso parse Int para cambiar
                            ...
                            //Si el user ingresa (coma) lo transforma a (punto) para q no problema en mysql, sentencia for
                            ...
                            //envio la descripción
                            producto.setDescripcion(txt_descripcion.getText().trim());
                            //envio porcentaje de iva
                            if (iva.equalsIgnoreCase("No tiene Iva")) {
                                producto.setPorcentaje(0);
                            } else if (iva.equalsIgnoreCase("19%")) {
                                producto.setPorcentaje(19);

                            }

                            //enviar idCategoria - cargar metodo q obtiene en el id categoria
                            this.IdCategoria();
    ...
    //Metodo limpiar campos registro producto
    ...
    // metodo para cargar las categorias lo llamo cargarcombocategorias
    private void CargarComboCategorias() {
        Connection cn = Conexion.conectar(); //objeto clase conexion
        String sql = "select * from tb_categoria";
        Statement st; //objeto clase statement

        try { //agrego try catch
    ...
    private int IdCategoria() {
        ...
        try {
            ...
            System.out.println("Error al obtener categoría");
        }
